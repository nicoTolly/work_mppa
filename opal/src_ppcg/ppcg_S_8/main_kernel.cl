__kernel void kernel0(__global float *Lattices, int c0)
{
    ...
    for (int c3 = 0; c3 <= 127; c3 += 32)
      for (int c5 = ppcg_max(t1_0, 1568 * b0 - 32 * b1 + 48 * t0_0 + t1_0 + 4 * ((t0_0 - t1_0 + 3) / 4)); c5 <= ppcg_min(31, 1568 * b0 - 32 * b1 + 49 * t0_0 + 127); c5 += 4)
        for (int c6 = t2_0; c6 <= 31; c6 += 4) {
          private_g = 0;
          if (t2_0 == 3 && c3 == 96 && c6 == 31) {
            private_g = (private_g | 5441);
          } else if (t2_0 == 0 && c3 == 0 && c6 == 0)
            private_g = (private_g | 10882);
          if (32 * b1 + c5 == 1568 * b0 + 49 * t0_0) {
            private_g = (private_g | 164616);
          } else if (32 * b1 + c5 == 1568 * b0 + 49 * t0_0 + 127)
            private_g = (private_g | 82116);
          if (b0 == 3 && t0_0 == 31) {
            private_g = (private_g | 52240);
          } else if (b0 == 0 && t0_0 == 0)
            private_g = (private_g | 208928);
          private_f0 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 0];
          if (private_g & 262143) {
            if (private_g & 2) {
              private_f1 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 2];
            } else {
              private_f1 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (-((-c3 - c6 + 4294967296) % 4294967296) + 4294967295)) * 19 + 1];
            }
            if (private_g & 1) {
              private_f2 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 1];
            } else {
              private_f2 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6 + 1)) * 19 + 2];
            }
            if (private_g & 8) {
              private_f3 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 4];
            } else {
              private_f3 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + ((-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 4294967295) % 4294967296)) * 128 + (c3 + c6)) * 19 + 3];
            }
            if (private_g & 4) {
              private_f4 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 3];
            } else {
              private_f4 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 1)) * 128 + (c3 + c6)) * 19 + 4];
            }
            if (private_g & 32) {
              private_f5 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 6];
            } else {
              private_f5 = Lattices[((((c0 % 2) * 128 + (-((-32 * b0 - t0_0 + 4294967296) % 4294967296) + 4294967295)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 5];
            }
            if (private_g & 16) {
              private_f6 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 5];
            } else {
              private_f6 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0 + 1)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 6];
            }
            if (private_g & 512) {
              private_f7 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 10];
            } else {
              private_f7 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + ((-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 4294967295) % 4294967296)) * 128 + (-((-c3 - c6 + 4294967296) % 4294967296) + 4294967295)) * 19 + 7];
            }
            if (private_g & 256) {
              private_f8 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 9];
            } else {
              private_f8 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + ((-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 4294967295) % 4294967296)) * 128 + (c3 + c6 + 1)) * 19 + 8];
            }
            if (private_g & 128) {
              private_f9 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 8];
            } else {
              private_f9 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 1)) * 128 + (-((-c3 - c6 + 4294967296) % 4294967296) + 4294967295)) * 19 + 9];
            }
            if (private_g & 64) {
              private_f10 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 7];
            } else {
              private_f10 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 1)) * 128 + (c3 + c6 + 1)) * 19 + 10];
            }
            if (private_g & 8192) {
              private_f11 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 14];
            } else {
              private_f11 = Lattices[((((c0 % 2) * 128 + (-((-32 * b0 - t0_0 + 4294967296) % 4294967296) + 4294967295)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (-((-c3 - c6 + 4294967296) % 4294967296) + 4294967295)) * 19 + 11];
            }
            if (private_g & 4096) {
              private_f12 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 13];
            } else {
              private_f12 = Lattices[((((c0 % 2) * 128 + (-((-32 * b0 - t0_0 + 4294967296) % 4294967296) + 4294967295)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6 + 1)) * 19 + 12];
            }
            if (private_g & 2048) {
              private_f13 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 12];
            } else {
              private_f13 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0 + 1)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (-((-c3 - c6 + 4294967296) % 4294967296) + 4294967295)) * 19 + 13];
            }
            if (private_g & 1024) {
              private_f14 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 11];
            } else {
              private_f14 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0 + 1)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6 + 1)) * 19 + 14];
            }
            if (private_g & 131072) {
              private_f15 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 18];
            } else {
              private_f15 = Lattices[((((c0 % 2) * 128 + (-((-32 * b0 - t0_0 + 4294967296) % 4294967296) + 4294967295)) * 128 + ((-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 4294967295) % 4294967296)) * 128 + (c3 + c6)) * 19 + 15];
            }
            if (private_g & 65536) {
              private_f16 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 17];
            } else {
              private_f16 = Lattices[((((c0 % 2) * 128 + (-((-32 * b0 - t0_0 + 4294967296) % 4294967296) + 4294967295)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 1)) * 128 + (c3 + c6)) * 19 + 16];
            }
            if (private_g & 32768) {
              private_f17 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 16];
            } else {
              private_f17 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0 + 1)) * 128 + ((-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 4294967295) % 4294967296)) * 128 + (c3 + c6)) * 19 + 17];
            }
            if (private_g & 16384) {
              private_f18 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 15];
            } else {
              private_f18 = Lattices[((((c0 % 2) * 128 + (32 * b0 + t0_0 + 1)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5 + 1)) * 128 + (c3 + c6)) * 19 + 18];
            }
            if ((32 * b0 + t0_0 <= 126 ? 0 : 1)) {
          ...
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 0] = private_f0;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 1] = private_f1;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 2] = private_f2;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 3] = private_f3;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 4] = private_f4;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 5] = private_f5;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 6] = private_f6;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 7] = private_f7;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 8] = private_f8;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 9] = private_f9;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 10] = private_f10;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 11] = private_f11;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 12] = private_f12;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 13] = private_f13;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 14] = private_f14;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 15] = private_f15;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 16] = private_f16;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 17] = private_f17;
          Lattices[(((((c0 + 1) % 2) * 128 + (32 * b0 + t0_0)) * 128 + (-1568 * b0 + 32 * b1 - 49 * t0_0 + c5)) * 128 + (c3 + c6)) * 19 + 18] = private_f18;
        }
}
